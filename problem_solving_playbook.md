...
* **What it is:** Time complexity tells you how the **running time** of your algorithm grows as the size of the input data gets larger. We use something called "Big O Notation" (like O(N), O($N^2$)) to describe this growth. It doesn't tell you the exact time in seconds, but rather how its performance *scales*.
...
* **Learn More:** [GeeksforGeeks - Space Complexity of Algorithms](https://www.geeksforgeeks.org/space-complexity-of-algorithms/)
...
* **Learn More:**
    ...
    * [GeeksforGeeks - Introduction to Arrays (concepts apply to Python lists)](https://www.geeksforgeeks.org/introduction-to-arrays/)
    ...
    * [GeeksforGeeks - Prefix Sum Array (concepts apply to Python)](https://www.geeksforgeeks.org/prefix-sum-array-in-cpp-with-examples/)
...
* **Learn More:** [Programiz - Introduction to Linked List](https://www.programiz.com/dsa/linked-list)
...
* **Learn More:** [GeeksforGeeks - Stack Data Structure](https://www.geeksforgeeks.org/stack-data-structure-introduction-applications/)
...
* **Learn More:** [GeeksforGeeks - Queue Data Structure](https://www.geeksforgeeks.org/queue-data-structure/)
...
* **Key Types:**
    ...
    * **Binary Trees:** Each node has at most two "children" (branches).
        ...
        * **Learn More:** [Programiz - Introduction to Trees](https://www.programiz.com/dsa/trees)
    ...
    * **Binary Search Trees (BSTs):** A special binary tree where all values in the left child's branch are smaller than the parent, and all values in the right child's branch are larger. This structure makes searching very efficient (like binary search, O(log N) on average).
        ...
        * **Learn More:** [GeeksforGeeks - Binary Search Tree](https://www.geeksforgeeks.org/binary-search-tree-data-structure/)
    ...
    * **Heaps (Priority Queues):** A special tree that makes it very fast to find the smallest (Min-Heap) or largest (Max-Heap) element. It's not necessarily sorted, but the "most important" element is always at the top. Python's `heapq` module provides heap functionality.
        ...
        * **Learn More:** [GeeksforGeeks - Heap Data Structure](https://www.geeksforgeeks.org/heap-data-structure/)
    ...
    * **Tries (Prefix Trees):** A tree-like data structure used for efficient retrieval of a key in a dataset of strings. Each node represents a character, and paths from the root form words.
        ...
        * **Learn More:** [GeeksforGeeks - Trie (Prefix Tree)](https://www.geeksforgeeks.org/trie-data-structure/)
...
* **Learn More:** [GeeksforGeeks - Graph Data Structure](https://www.geeksforgeeks.org/graph-data-structure-and-algorithms/)
...
* **Learn More:** [Programiz - Python Dictionary](https://www.programiz.com/python-programming/dictionary)
...
* **Learn More:** [GeeksforGeeks - Brute Force Algorithm](https://www.geeksforgeeks.org/brute-force-algorithm/)
...
* **Learn More:** [GeeksforGeeks - Greedy Algorithms](https://www.geeksforgeeks.org/greedy-algorithms/)
...
* **Steps:**
    ...
    1.  **Divide:** Split the problem into two or more smaller, independent sub-problems.

    2.  **Conquer:** Solve each sub-problem recursively. If a sub-problem is small enough, solve it directly (this is your "base case").

    3.  **Combine:** Put the solutions of the sub-problems back together to get the solution for the original problem.
...
* **Learn More:** [GeeksforGeeks - Divide and Conquer Algorithm](https://www.geeksforgeeks.org/divide-and-conquer-algorithm-introduction/)
...
* **Learn More:** [FreeCodeCamp - What is Dynamic Programming?](https://www.freecodecamp.org/news/what-is-dynamic-programming-a-beginners-guide/) (with examples)
...
* **Learn More:** [GeeksforGeeks - Backtracking Algorithm](https://www.geeksforgeeks.org/backtracking-algorithms/)
...
* **Key Types:**
    ...
    * **Traversal Algorithms (Python):**
        ...
        * **Learn More:** [GeeksforGeeks - BFS vs DFS](https://www.geeksforgeeks.org/breadth-first-search-vs-depth-first-search/)
    ...
    * **Shortest Path Algorithms:**
        ...
        * **Learn More:** [Programiz - Dijkstra's Algorithm](https://www.programiz.com/dsa/dijkstra-algorithm)
    ...
    * **Minimum Spanning Tree (MST):** Finding a subset of edges that connects all nodes with the minimum possible total "cost" (edge weight).
        ...
        * **Learn More:** [GeeksforGeeks - Minimum Spanning Tree (MST)](https://www.geeksforgeeks.org/minimum-spanning-tree-mst/)
    ...
    * **Topological Sort:** For Directed Acyclic Graphs (DAGs - graphs with one-way connections and no cycles), it gives you a linear ordering of nodes such that if there's a path from A to B, A comes before B in the ordering. Useful for task scheduling with dependencies.
        ...
        * **Learn More:** [GeeksforGeeks - Topological Sort](https://www.geeksforgeeks.org/topological-sorting/)
...
* **Learn More:** [Khan Academy - Binary search](https://www.khanacademy.org/computing/computer-science/algorithms/binary-search/a/binary-search)
...
* **Key Types (and their average time complexity):**
    ...
    * **Quick Sort:** O(N log N) - Often faster in practice, but worst-case O($N^2$).

    * **Heap Sort:** O(N log N) - Uses a heap data structure.

    * *(Less common in competitive programming for large inputs due to O($N^2$) worst case, but good to know)*: Bubble Sort, Insertion Sort, Selection Sort.
...
* **Learn More:** [GeeksforGeeks - Sorting Algorithms](https://www.geeksforgeeks.org/sorting-algorithms/)
...
* **Learn More:** [Programiz - Recursion in Programming](https://www.programiz.com/dsa/recursion)
...
* **Learn More:** [GeeksforGeeks - Bit Manipulation in C++ (Concepts apply to Python too!)](https://www.geeksforgeeks.org/bit-manipulation-in-cpp/) (Focus on the concepts, as syntax might differ slightly)
...
* **Learn More:** [Educative.io - Two Pointers Pattern](https://www.educative.io/courses/grokking-the-coding-interview/R1MB7D3x5zr)
...
* **Learn More:** [GeeksforGeeks - Sliding Window Technique](https://www.geeksforgeeks.org/window-sliding-technique/)
...
* **Learn More:** [GeeksforGeeks - Prefix Sum Array (concepts apply to Python)](https://www.geeksforgeeks.org/prefix-sum-array-in-cpp-with-examples/)
...
* **Learn More:** [GeeksforGeeks - Basic Number Theory for Competitive Programming](https://www.geeksforgeeks.org/basic-number-theory-for-competitive-programming/)
...
* **Constraints:** Look for limits on input size (N), value ranges (e.g., numbers between 1 and $10^9$), and time/memory limits. These are CRITICAL for deciding your algorithm's efficiency.

    * *Rule of Thumb for N vs. Time Complexity:*

        * N up to \~10-12: O(N!), O($2^N$) might pass (Brute force, Backtracking).

        * N up to \~20-25: O($2^N$) might barely pass.

        * N up to \~500: O($N^3$) is usually too slow, O($N^2$) might pass.
...
* **Review Constraints:** Given the constraints, is your current complexity acceptable?
    ...
    * If **NO** (e.g., O($N^2$) is too slow for N = $10^5$), go back to Step 2 or 3. Can you use a different data structure? Is there a more advanced algorithm paradigm that applies? Could a simple trick like Two Pointers or Prefix Sums optimize a part of your solution?
